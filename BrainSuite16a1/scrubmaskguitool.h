...
#ifndef SCRUBMASKGUITOOL_H
#define SCRUBMASKGUITOOL_H

#include <extractionguitool.h>

class ScrubMaskGUITool : public ExtractionGUITool {
public:
  enum ScrubState { Scrub = 0, Finished = 1 };
  ScrubMaskGUITool();
