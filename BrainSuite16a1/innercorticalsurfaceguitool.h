...
#ifndef INNERCORTICALSURFACEGUITOOL_H
#define INNERCORTICALSURFACEGUITOOL_H

#include <extractionguitool.h>

class InnerCorticalSurfaceGUITool : public ExtractionGUITool {
public:
  enum State { MakeSurface = 0, Finished = 1 };
  InnerCorticalSurfaceGUITool();
...
#endif // INNERCORTICALSURFACEGUITOOL_H
