...
void AIR_passf(unsigned int *nac, const unsigned int ido, const unsigned int ip, const unsigned int l1, const unsigned int idl1, double *cc, double *c1, double *c2, double *ch, double *ch2, const double *wa)
			...
			}
			{
				...
				inc+=ido;
				{
					...
					for(j=2;j<ipph;j++){
						...
						unsigned int jc=ip-j;
						idlj+=inc;
						/* idlj != idp due to its incrementation by ido's from 1 */
