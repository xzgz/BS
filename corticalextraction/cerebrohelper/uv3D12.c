 ...
 * respect to the paramaters for a full affine 12
...
void AIR_uv3D12(const double *i, double **ef, double ***def, double ****eef, /*@unused@*/ const struct AIR_Key_info* reslice_info, /*@unused@*/ const struct AIR_Key_info *standard_info, /*@unused@*/ const AIR_Boolean zooming)
