 ...
 *  of the normalized const function with respect to all
 *  external parameters.
 *
...

{
	...
	/* "create_vols.c" for an illustcfn of how this is assured*/
...

			{
				...
				/* Find the x, y, and z coordinates */
				{
					...
					/* in the reslice file*/
					{
						...
						if(lesion[k][y_down][x_down]!=0) continue;
						if(lesion[k][y_down][x_up]!=0) continue;
						if(lesion[k][y_up][x_down]!=0) continue;
						if(lesion[k][y_up][x_up]!=0) continue;
