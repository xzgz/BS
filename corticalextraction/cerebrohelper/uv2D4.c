...

{
	...
	x[4]=x[1]*cosyaw+y[1]*sinyaw;
		...
		dx[4][3]=dx[1][3]*cosyaw+dy[1][3]*sinyaw;
			...
			ex[4][3][3]=0.0; /*ex[1][3][3]*cosyaw+ey[1][3][3]*sinyaw;*/
	...
	y[3]=y[1]*cosyaw-x[1]*sinyaw;
		...
		dy[3][3]=dy[1][3]*cosyaw-dx[1][3]*sinyaw;
			...
			ey[3][3][3]=0.0; /*ey[1][3][3]*cosyaw-ex[1][3][3]*sinyaw;*/
	...
	e[0]=(x[4]-p+(x_dim2-1)*xoom2)/(2.0*xoom2);
		...
		de[0][2]=0.0;
			...
			ee[0][2][1]=0.0;
			ee[0][2][2]=0.0;
		de[0][3]=dx[4][3]/(2.0*xoom2);
			ee[0][3][0]=ex[4][3][0]/(2.0*xoom2);
			ee[0][3][1]=0.0;
			ee[0][3][2]=0.0;
			ee[0][3][3]=ex[4][3][3]/(2.0*xoom2);
	...
	e[1]=(y[3]-q+(y_dim2-1)*yoom2)/(2.0*yoom2);
		...
		de[1][2]=-1.0/(2.0*yoom2);
			...
			ee[1][2][1]=0.0;
			ee[1][2][2]=0.0;
		de[1][3]=dy[3][3]/(2.0*yoom2);
			ee[1][3][0]=ey[3][3][0]/(2.0*yoom2);
			ee[1][3][1]=0.0;
			ee[1][3][2]=0.0;
			ee[1][3][3]=ey[3][3][3]/(2.0*yoom2);
