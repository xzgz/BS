					...
					double ratio, dratio[PARAM_INT];
					{
						...
						/* Second derivatives */
						{
							...
							}
							{
								...
								for(; t<BLOCK3; t++, dxt++, dyt++, dratiot++){
									...
									
									{
										...
										for(s=BLOCK0; s<BLOCK1; s++, emeanpix1ts++, esquarepix1ts++, dratios++, dxs++, exts++){
											...
											/* eratio[t][s]+=dx[s]*(ezpix4*dy[t]); */
											eratiots+=*dxs*(ezpix4**dyt);
									...
									}
									{
										...
										for(; s<BLOCK2; s++, emeanpix1ts++, esquarepix1ts++, dratios++, dys++, eyts++){
											...
											/* eratio[t][s]+=dy[s]*(ezpix4*dx[t]); */
											eratiots+=*dys*(ezpix4**dxt);
									...
									}
									{
										...
										for(; s<=t; s++, emeanpix1ts++, esquarepix1ts++, dratios++, dxs++, dys++, exts2++, eyts2++){
										
											/* eratio[t][s]=(dxpix4*ex[t][s]+dypix4*ey[t][s]);*/
											double eratiots=(dxpix4**exts2+dypix4**eyts2);
