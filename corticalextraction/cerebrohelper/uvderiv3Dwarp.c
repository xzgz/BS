 ...
 *
 * Note that derivatives with respect to external parameters are ignormed
 */
						...
						for(; t<2*coeffp; t++, dyt++){
							...
							
							{
								...
								for(s=0; s<coeffp; s++, ecfts++, dxs++){
									...
									*ecfts+=2.0**dyt**dxs*(dxpix4*dypix4+(pix4-spix3)*ezpix4);
								}
							}
							{
								double *dys=dx;
						...
						for(; t<3*coeffp; t++, dzt++){
							...
							
							{
								...
								for(s=0; s<coeffp; s++, ecfts++, dxs++){
									...
									*ecfts+=2.0**dzt**dxs*(dxpix4*dzpix4+(pix4-spix3)*eypix4);
								}
							}
							{
								double *dys=dx;
								...
								for(; s<2*coeffp; s++, ecfts++, dys++){
									...
									*ecfts+=2.0**dzt**dys*(dypix4*dzpix4+(pix4-spix3)*expix4);
								}
							}
							{
								double *dzs=dx;
