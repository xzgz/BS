...
/*
 * This routine will apply es to i1,j1,k1 to find *i_new,*j_new,*k_new
...
AIR_Error AIR_warp3D(double **es, const double i1, const double j1, const double k1, double *i_new, double *j_new, double *k_new, const unsigned int order, double *dx)
