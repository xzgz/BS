...
/*
 * This routine will exchange the y_dimension ordering of a volume
 *
 * Returns:
...
AIR_Pixels ***AIR_flip_y(AIR_Pixels ***volume, const struct AIR_Key_info *stats, AIR_Error *errcode)
...

{
	...
	/* Fill in the data */
	{
		...
		AIR_Pixels ***k1_end=volume+z_dim;
		
		for (;k1<k1_end;k1++,k2++){
		
			AIR_Pixels **j1=*k1;
			AIR_Pixels **j2=*k2+y_dim-1;
