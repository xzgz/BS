...
void AIR_passb3(const unsigned int ido, const unsigned int l1, double *cc, double *ch, const double *wa1, const double *wa2)

{
	unsigned int ccz=3*ido;
	unsigned int chz=l1*ido;

	double taur=-.5;
	double taui=.5*sqrt(3.0);
