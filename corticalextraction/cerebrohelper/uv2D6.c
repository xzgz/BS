 ...
 * respect to the parameters for an in-plane affine
 * 6 parameter model.
 *
...
void AIR_uv2D6(const double *i, double **ef, double ***def, double ****eef, /*@unused@*/ const struct AIR_Key_info *reslice_info, /*@unused@*/ const struct AIR_Key_info *standard_info, /*@unused@*/ const AIR_Boolean zooming)
